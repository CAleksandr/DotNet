    ...
    public class CollHelper
    {
        ...
        public void ReadFromFile(string filename, Collection array)
        {
            ...
            while ((ReadDataLine = sr.ReadLine()) != null)
            {
                ...
                Student new_student = new Student(ReadDataArr[0], 
                    ReadDataArr[1], ReadDataArr[2], Convert.ToChar(ReadDataArr[3]), ReadDataArr[4], ReadDataArr[5], new DateTime(Convert.ToInt32(BirthTimeDate[2]), 
                    Convert.ToInt32(BirthTimeDate[1]), Convert.ToInt32(BirthTimeDate[0])), 
                    new DateTime(Convert.ToInt32(AdmTimeDate[2]), Convert.ToInt32(AdmTimeDate[1]), 
                    Convert.ToInt32(AdmTimeDate[0])), Convert.ToByte(ReadDataArr[8]));
